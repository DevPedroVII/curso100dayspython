...
#As ligações do Selenium Python fornecem uma API simples para escrever testes funcionais/de aceitação usando o Selenium
# WebDriver. Através da Selenium Python API você pode acessar todas as funcionalidades do Selenium WebDriver de forma intuitiva.
